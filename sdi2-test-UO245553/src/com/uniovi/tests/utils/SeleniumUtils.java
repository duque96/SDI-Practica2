...
public class SeleniumUtils {
	 ...
	 *            consulta xpath.
	 * @param timeout:
	 *            el tiempo máximo que se esperará por la aparición del elemento a
	 *            buscar con xpath
	 ...
	 * @param timeout:
	 *            el tiempo máximo que se esperará por la apareción del elemento a
	 *            buscar con criterio/text.
	 ...
	 *            apuntando al navegador abierto actualmente.
	 * @param segundos:
	 *            Segundos de bloqueo de la ejecución en el navegador.
	 */
